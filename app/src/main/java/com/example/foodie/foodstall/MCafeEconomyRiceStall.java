...
public class MCafeEconomyRiceStall extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mcafe_economy_rice_stall); // Make sure this matches your XML file name
        ...
        menuButton.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(MCafeEconomyRiceStall.this, "Menu Clicked!", Toast.LENGTH_SHORT).show();
                Intent intent = new Intent(MCafeEconomyRiceStall.this, MCafeEconomyRiceStallMenu.class);
        ...
        discussionCommunity.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(MCafeEconomyRiceStall.this, "Navigating to Dicussion Community page...", Toast.LENGTH_SHORT).show();
                        // Create an Intent to start LocationActivity
                        Intent intent = new Intent(MCafeEconomyRiceStall.this, DiscussionCommunity.class);
                        startActivity(intent);
                    }
                });
        // below is the sample action to handle add alarm
        ...
        feedback.setOnClickListener(
                new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Toast.makeText(MCafeEconomyRiceStall.this, "Navigating to Feedback page...", Toast.LENGTH_SHORT).show();

                        // Create an Intent to start LocationActivity
                        Intent intent = new Intent(MCafeEconomyRiceStall.this, Feedback.class);
                        startActivity(intent);
                    }
                });
    }
