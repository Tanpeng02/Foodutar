...
public class LocationcFourNoodlesStall extends AppCompatActivity {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.location_cfour_noodles_stall);

        EditText editTextSource = findViewById(R.id.cFoursource);
        EditText editTextDestination = findViewById(R.id.cFourdestination);
