...
public class LocationLocationUncleAlanVegetarian extends AppCompatActivity {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.location_location_uncle_alan_vegetarian);

        EditText editTextSource = findViewById(R.id.Unclesource);
        EditText editTextDestination = findViewById(R.id.Uncledestination);
