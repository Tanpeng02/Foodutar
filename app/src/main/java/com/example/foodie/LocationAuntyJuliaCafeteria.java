...
public class LocationAuntyJuliaCafeteria extends AppCompatActivity {

    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.location_aunty_julia_cafeteria);

        EditText editTextSource = findViewById(R.id.Auntysource);
        EditText editTextDestination = findViewById(R.id.Auntydestination);
