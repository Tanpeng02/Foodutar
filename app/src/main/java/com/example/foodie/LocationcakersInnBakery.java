...
public class LocationcakersInnBakery extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.location_cakers_inn_bakery);

        EditText editTextSource = findViewById(R.id.cakersource);
        EditText editTextDestination = findViewById(R.id.cakerdestination);
